            ...
            <div class="my-post-list-card" v-for="(post, postIndex) in postList" :key="postIndex">
                <el-card>
                    ...
                    <el-main class="post-main">
                        ...
                        <a class="post-text-a btn" href="#" v-if="post.OverFlow" @click.prevent="toggleCollapse(postIndex)">
                    ...
                    <div v-if="post.CommentPostVisible" class="comment-module">
                        <div class="comment-top flex-box">
                            ...
                            <el-input class="comment-top-input flex-center" placeholder="发表你的评论~" v-model="post.NowCommentContent"></el-input>
                            <div class="comment-top-img flex-box align-center btn">
                                <el-upload
                        ...
                        <div class="comment-main">
                            <el-row class="comment-single flex-box" v-for="(postComment, postCommentIndex) of post.PostCommentList" :key="postCommentIndex">
                                ...
                                <div class="comment-single-right">
                                    <div class="comment-single-right-top">
                                        <a class="comment-single-username" href="#">{{ postComment.UserName }}</a>
                                    ...
                                    <div class="comment-single-right-footer flex-space-between align-center">
                                        ...
                                        <div class="comment-single-right-footer-right flex-box align-center">
                                            <div class="comment-single-delete btn hover-orange gray">
                                                <el-icon :size="16" @click="deleteComment(postComment.Id)">
                                                    <Delete />
                                                </el-icon>
                                            </div>
                                            <div class="comment-single-comment btn hover-orange gray" @click="commentComment(postComment.Id)">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chat-square-text" viewBox="0 0 16 16">
                                                    <path d="M14 1a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1h-2.5a2 2 0 0 0-1.6.8L8 14.333 6.1 11.8a2 2 0 0 0-1.6-.8H2a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1h12zM2 0a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h2.5a1 1 0 0 1 .8.4l1.9 2.533a1 1 0 0 0 1.6 0l1.9-2.533a1 1 0 0 1 .8-.4H14a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2z"/>
                                                    <path d="M3 3.5a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5zM3 6a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9A.5.5 0 0 1 3 6zm0 2.5a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5z"/>
                                                </svg>
                            ...
                            <p class="load-text btn" v-if="!post.NoMore" @click="loadMoreComment(postIndex, post.Id)">查看更多评论</p>
...
export default {
    ...
    setup() {
        ...
        const commentPostShow = (index) => {
            console.log(postList.value[index].CommentPostList);
